...
def placeOrder(request):
    ...
    for item in items:
        ...
        # Move the message creation inside the loop
        ...
        message = (
            ...
            + " Your order was placed successfully. Please go to your dashboard to see your order history. <br> Your order id is "
            + str(order.id)
        )
