...
urlpatterns = [
    ...
    url('dashboard/admin/index.html', views.index, name='index'),

    url(r'cart/index.html', views.index, name='index'),  # Example for the cart view
    url(r'dashboard/admin/foods/foodDetails/1/index.html', views.index, name='index'),
    url(r'dashboard/admin/foods/foodDetails/2/index.html', views.index, name='index'),
    url(r'dashboard/admin/foods/foodDetails/1/menu.html', views.index, name='index')
